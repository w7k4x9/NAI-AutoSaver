(function bootstrapNaiAutoSaver(global) {
  ...
  let saveContext = { baseName: "", counter: 0 };
  ...
  async function maybeDownloadCurrentImage() {
    ...
    // Wait for a real, fully-decoded image before grabbing it. The generate
    // button can re-enable a beat before the new image finishes swapping in.
  ...
  async function startAutoGenerate({ target = 0, saveName = "", applyPrompt = null, applyBasePrompt = null, applyCharacterPrompt = null } = {}) {
    ...
    saveContext = { baseName: saveName || "", counter: 0 };
